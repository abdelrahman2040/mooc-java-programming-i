...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Multiplier multiplyerByThree = new Multiplier(3);
        System.out.println(" multiplyByThree.multiply(2): " + multiplyerByThree.multiply(2));
        ...
        System.out.println("multiplyByThree.multiply(1): " + multiplyerByThree.multiply(1));
